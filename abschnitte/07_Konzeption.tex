...
Da eine so umfangreiche Umgebung bei der Erarbeitung eines Konzeptes und einer anschließenden Implementierung zumindest den Rahmen dieser Arbeit sprengt, ist es notwendig eine einfachere Umgebung zu definieren. Diese sollte jedoch dafür ausreichen, die Lösung der Probleme der aktuellen Testumgebungen zu zeigen.
