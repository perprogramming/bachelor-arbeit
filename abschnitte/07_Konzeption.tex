...
\begin{figure}[!ht]
  \begin{center}
    \begin{gherkincode}
Feature: Isolated Database

  Scenario:
    Given I start environment "test1"
    And I open "/counter.php"
    Then I should see "0"
    When I reload the page
    Then I should see "1"
    When I start environment "test2"
    And I open "/counter.php"
    Then I should see "0"

    \end{gherkincode}
    \caption{Beispiel-Feature für den Test isolierter Daten}
  \end{center}
\end{figure}
