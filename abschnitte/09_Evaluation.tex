...
\begin{figure}[!ht]
  \begin{center}
    \resizebox{15cm}{!} {
      ...
      \hline
      Dauer der Erzeugung von Maschinen-Abbildern bzw. OS-Container-Images & 5 \\
      \hline
